    ...
    DDH.play_chess.build = function(ops) {
        ...
        return {
            ...
            onShow: function() {
              ...
              document.X = X = function (w, c, h, e, S, s) {
                  var t, o, L, E, d, O = e,
                      N = -M * M,
                      K = 78 - h << x,
              ...
              document.Y = function(s) {
                  ...
                  if (i > 8) {
                      ...
                      i = I[B] & z;
                      if ((i &
                              7) == 1 & (b < 29 | b > 90)) i = 14 - document.getElementById("t").selectedIndex ^ y;
                      X(0, 0, 0, 21,
                          u, 1);
